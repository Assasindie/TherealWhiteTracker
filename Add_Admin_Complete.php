...
<html lang="en">
  <head>
    ...
    <title> Add Admin Complete </title>
  ...
  <body>
	...
	global $_New_Admin_Pass;

	$_New_Admin_User = $_POST['Admin_UserName'];
	$_New_Admin_Pass = $_POST['Admin_Password'];
	
	$_New_Admin_User  = stripslashes($_New_Admin_User );
	$_New_Admin_Pass = stripslashes($_New_Admin_Pass);
	$_New_Admin_User  = mysqli_real_escape_string($_New_Admin_User );
	$_New_Admin_Pass = mysqli_real_escape_string($_New_Admin_Pass);

	$sql= "INSERT INTO `login`(`UserName`, `Pass`) VALUES ('$_New_Admin_User','$_New_Admin_Pass')";
