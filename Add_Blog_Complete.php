...
<?php if($_SESSION["LoginFailed"] == "0"){?> <li><a href = "Add_Drop.php" >Add a new white bag drop! </a></li> <?php } ?>
	...
	global $_New_Blog_Text;
	global $_New_Blog_Date;

	$_New_Blog_Text = $_POST['Blog_Text'];
	$_New_Blog_Date = $_POST['Blog_Date'];
	

	$sql= "INSERT INTO `blog`(`Text`, `Date`) VALUES ('$_New_Blog_Text','$_New_Blog_Date')";
