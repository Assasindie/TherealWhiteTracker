	    ...
	    <div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 centered">
					...
					<h1>Contact Us</h1>
					<p>Enter your message below, leave your name and contact details and we will get back to you!</p>
				</div><!-- /col-lg-8 -->
			</div><!-- /row -->
	    </div> <!-- /container -->
	</div><!-- /ww -->
	    ...
	    <div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 centered">
					...
					Subject <textarea type = "text" name = "Subject" style = "width : 600px" required> </textarea> </br> </br>
					Message <textarea type = "text" name = "Message" style="width : 600px ; height: 300px" required >  </textarea> </br> </br>
					Captcha Password  <input name="password" size="6" />
