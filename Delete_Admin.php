...
<?php if($_SESSION["LoginFailed"] == "0"){?> <li><a href = "Add_Drop.php" >Add a new white bag drop! </a></li> <?php } ?>
	...
	<form action = "Delete_Admin_Complete.php" method = "post">
		<div id="ww">
	    <div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 centered">
					Admin UserName to Delete <input type = "text" name = "Admin_UserName" style = "width : 200px" required> </input> </br> </br>
