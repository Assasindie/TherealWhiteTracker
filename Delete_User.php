...
$Delete_User_sql = "Select * FROM `normal_login`";
$Delete_User = mysqli_query($Delete_User_sql) or die (mysqli_error());
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<?php if($_SESSION["LoginFailed"] == "0"){?> <li><a href = "Add_Drop.php" >Add a new white bag drop! </a></li> <?php } ?>
	...
	<form action = "Delete_User_Complete.php" method = "post">
		<div id="ww">
	    <div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 centered">
					 UserName to Delete <input type = "text" name = "UserName" style = "width : 200px" required> </input> </br> </br>
	...
	<?php 	
	while              {
echo "<tr> <td>" . $Result['User_Name']. "</td> <td>".$Result['First_Name'] ."</td> <td>". $Result['Last_Name'] . "</td> <td>" . $Result['User_ID'] . "</td></tr>";
}
?>
		<?php
	}else{
