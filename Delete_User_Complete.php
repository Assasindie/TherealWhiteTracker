...
<?php if($_SESSION["LoginFailed"] == "0"){?> <li><a href = "Add_Drop.php" >Add a new white bag drop! </a></li> <?php } ?>
	...
	$_Delete_User = $_POST['UserName'];
	
	$_Delete_User  = stripslashes($_Delete_User );

	$_Delete_User  = mysqli_real_escape_string($_Delete_User );

	$sql= "DELETE FROM `normal_login` WHERE `User_Name` = '$_Delete_User' ";
	...
	?>	
	    ...
	    <div class="container">
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2 centered">
				Sucess </br> </br>
				<a href = "Admin_Profile.php"> Return to Login </a> </href>
				</div><!-- /col-lg-8 -->
			</div><!-- /row -->
	    </div> <!-- /container -->
	</div><!-- /ww -->
